...
<p align="center">
  <a href="https://labex.io/zh/learn/comptia">
...
[在 LabEx 浏览项目](https://labex.io/zh/learn/comptia)

## 项目

探索 4 个适合初学者的 CompTIA 项目，将核心概念应用到小而完整的程序中。每个项目都会在 LabEx 中打开可直接使用的环境，让你专注于动手构建。

|   序号 | 项目                                                                                          | 难度   | 练习                                                                      |
|------|---------------------------------------------------------------------------------------------|------|-------------------------------------------------------------------------|
|    1 | [CompTIA Linux+ 认证实战实验](https://labex.io/zh/courses/comptia-linux-plus-training-labs)       | 初级   | [开始项目](https://labex.io/zh/courses/comptia-linux-plus-training-labs)    |
|    2 | [CompTIA Network+ 认证培训实验](https://labex.io/zh/courses/comptia-network-plus-training-labs)   | 初级   | [开始项目](https://labex.io/zh/courses/comptia-network-plus-training-labs)  |
|    3 | [CompTIA Security+ 认证培训实验](https://labex.io/zh/courses/comptia-security-plus-training-labs) | 初级   | [开始项目](https://labex.io/zh/courses/comptia-security-plus-training-labs) |
|    4 | [CompTIA A+ 认证实训实验](https://labex.io/zh/courses/comptia-a-plus-training-labs)               | 初级   | [开始项目](https://labex.io/zh/courses/comptia-a-plus-training-labs)        |

[在 LabEx 查看更多](https://labex.io/zh/learn/comptia)
