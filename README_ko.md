...
<p align="center">
  <a href="https://labex.io/ko/learn/comptia">
...
[LabEx에서 프로젝트 보기](https://labex.io/ko/learn/comptia)

## 프로젝트

초보자에게 적합한 4개의 CompTIA 프로젝트로 핵심 언어 개념을 작고 완성된 프로그램으로 만들어 보세요. 각 프로젝트는 LabEx의 바로 사용할 수 있는 환경에서 열리므로 구현에 집중할 수 있습니다.

|   인덱스 | 프로젝트                                                                                             | 난이도   | 연습                                                                         |
|-------|--------------------------------------------------------------------------------------------------|-------|----------------------------------------------------------------------------|
|     1 | [CompTIA Linux+ 자격증 취득 실습 랩](https://labex.io/ko/courses/comptia-linux-plus-training-labs)       | 초급    | [프로젝트 시작](https://labex.io/ko/courses/comptia-linux-plus-training-labs)    |
|     2 | [CompTIA Network+ 자격증 취득 실습 랩](https://labex.io/ko/courses/comptia-network-plus-training-labs)   | 초급    | [프로젝트 시작](https://labex.io/ko/courses/comptia-network-plus-training-labs)  |
|     3 | [CompTIA Security+ 자격증 취득 실습 랩](https://labex.io/ko/courses/comptia-security-plus-training-labs) | 초급    | [프로젝트 시작](https://labex.io/ko/courses/comptia-security-plus-training-labs) |
|     4 | [CompTIA A+ 자격증 교육 실습](https://labex.io/ko/courses/comptia-a-plus-training-labs)                 | 초급    | [프로젝트 시작](https://labex.io/ko/courses/comptia-a-plus-training-labs)        |

[LabEx에서 더 보기](https://labex.io/ko/learn/comptia)
