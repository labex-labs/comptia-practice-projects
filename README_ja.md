...
<p align="center">
  <a href="https://labex.io/ja/learn/comptia">
...
[LabEx でプロジェクトを見る](https://labex.io/ja/learn/comptia)

## プロジェクト

初心者向けの 4 個の CompTIA プロジェクトで、言語の重要な概念を小さく完成したプログラムに変えて学べます。各プロジェクトは LabEx のすぐ使える環境で開くため、構築に集中できます。

|   インデックス | プロジェクト                                                                                          | 難易度   | 練習                                                                           |
|----------|-------------------------------------------------------------------------------------------------|-------|------------------------------------------------------------------------------|
|        1 | [CompTIA Linux+ 認定トレーニングラボ](https://labex.io/ja/courses/comptia-linux-plus-training-labs)       | 初級    | [プロジェクトを開始](https://labex.io/ja/courses/comptia-linux-plus-training-labs)    |
|        2 | [CompTIA Network+ 認定トレーニングラボ](https://labex.io/ja/courses/comptia-network-plus-training-labs)   | 初級    | [プロジェクトを開始](https://labex.io/ja/courses/comptia-network-plus-training-labs)  |
|        3 | [CompTIA Security+ 認定トレーニングラボ](https://labex.io/ja/courses/comptia-security-plus-training-labs) | 初級    | [プロジェクトを開始](https://labex.io/ja/courses/comptia-security-plus-training-labs) |
|        4 | [CompTIA A+ 認定トレーニングラボ](https://labex.io/ja/courses/comptia-a-plus-training-labs)               | 初級    | [プロジェクトを開始](https://labex.io/ja/courses/comptia-a-plus-training-labs)        |

[LabEx でもっと見る](https://labex.io/ja/learn/comptia)
